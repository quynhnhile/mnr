...
import { CancelEstimateDetailServiceResult } from './cancel-estimate-detail.service';

@Controller(routesV1.version)
export class CancelEstimateDetailHttpController {
  constructor(
  ...
  @ApiOperation({ summary: 'Cancel an EstimateDetail' })
  @ApiBearerAuth()
  @ApiParam({
    name: 'estimateId',
  ...
  async cancel(
    ...
    const result: CancelEstimateDetailServiceResult =
