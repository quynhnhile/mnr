...
import { SendOprEstimateDetailServiceResult } from './send-opr-estimate-detail.service';

@Controller(routesV1.version)
export class SendOprEstimateDetailHttpController {
  constructor(
  ...
  @ApiOperation({ summary: 'Send opr an EstimateDetail' })
  @ApiBearerAuth()
  @ApiParam({
    name: 'estimateId',
  ...
  async sendOpr(
    ...
    const result: SendOprEstimateDetailServiceResult =
