...
import { RequestActiveEstimateDetailServiceResult } from './request-active-estimate-detail.service';

@Controller(routesV1.version)
export class RequestActiveEstimateDetailHttpController {
  constructor(
  ...
  @ApiOperation({ summary: 'Request active an EstimateDetail' })
  @ApiBearerAuth()
  @ApiParam({
    name: 'estimateId',
  ...
  async approve(
    ...
    const result: RequestActiveEstimateDetailServiceResult =
