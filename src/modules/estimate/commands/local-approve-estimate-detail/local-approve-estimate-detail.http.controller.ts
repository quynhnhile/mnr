...
import { LocalApproveEstimateDetailServiceResult } from './local-approve-estimate-detail.service';

@Controller(routesV1.version)
export class LocalApproveEstimateDetailHttpController {
  constructor(
  ...
  @ApiOperation({ summary: 'Local approve an EstimateDetail' })
  @ApiBearerAuth()
  @ApiParam({
    name: 'estimateId',
  ...
  async localApprove(
    ...
    const result: LocalApproveEstimateDetailServiceResult =
