...
import FederatedIdentityRepresentation from '../defs/federated-identity-representation';
import GroupRepresentation from '../defs/group-representation';
import MappingsRepresentation from '../defs/mappings-representation';
import { RequiredActionAlias } from '../defs/required-action-provider-representation';
import RoleRepresentation, {
  RoleMappingPayload,
} from '../defs/role-pepresentation';
import UserConsentRepresentation from '../defs/user-consent-representation';
import {
  UserProfileConfig,
  UserProfileMetadata,
} from '../defs/user-profile-metadata';
...
export class Users extends Resource<{ realm?: string }> {
  ...
  public getProfile = this.makeRequest<object, UserProfileConfig>({
    method: 'GET',
    path: '/profile',
  });
  ...
  public getProfileMetadata = this.makeRequest<object, UserProfileMetadata>({
    method: 'GET',
  ...
  public listRoleMappingsOfUser = this.makeRequest<
