...
import CertificateRepresentation from '../defs/certificate-representation';
import ClientRepresentation from '../defs/client-representation';
import ClientScopeRepresentation from '../defs/client-scope-representation';
import CredentialRepresentation from '../defs/credential-representation';
import GlobalRequestResult from '../defs/global-request-result';
import KeyStoreConfig from '../defs/keystore-config';
import { ManagementPermissionReference } from '../defs/management-permission-reference';
import MappingsRepresentation from '../defs/mappings-representation';
import PolicyEvaluationResponse from '../defs/policy-evaluatio-response';
import PolicyProviderRepresentation from '../defs/policy-provider-representation';
import PolicyRepresentation from '../defs/policy-representation';
import ProtocolMapperRepresentation from '../defs/protocol-mapper-representation';
import ResourceEvaluation from '../defs/resource-evaluation';
import ResourceRepresentation from '../defs/resource-representation';
import ResourceServerRepresentation from '../defs/resource-server-representation';
import RoleRepresentation from '../defs/role-pepresentation';
import ScopeRepresentation from '../defs/scope-representation';
import UserRepresentation from '../defs/user-representation';
import UserSessionRepresentation from '../defs/user-session-representation';
...
export class Clients extends Resource<{ realm?: string }> {
  ...
  public delSessions = this.makeRequest<
    { id: string; first?: number; max?: number },
    UserSessionRepresentation[]
  >({
    method: 'DELETE',
  ...
  public findScope = this.makeRequest<
