...
import { Entity, EntityID } from '../ddd/entity.base';
import { ValueObject } from '../ddd/value-object.base';

function isEntity(obj: unknown): obj is Entity<unknown, EntityID> {
  /**
  ...
  return (
    ...
    ValueObject.isValueObject((obj as Entity<unknown, EntityID>).id)
  );
}
